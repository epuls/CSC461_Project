...
namespace TrueWave
{
    ...
    public class EqualizerPreset : ScriptableObject
    {
        ...
        {
            Bell,
            [InspectorName("Hight Shelf")] Highshelf,
            [InspectorName("Low Shelf")] Lowshelf
        }
        ...
        private struct Filter
        {
            ...
            [Range(XMin, XMax)] public float center;
            [Range(-1, 2)] public float value;
            [Range(MinWidth, 3)] public float width;
