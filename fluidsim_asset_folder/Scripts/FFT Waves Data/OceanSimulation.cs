...
namespace TrueWave
{
    public class OceanSimulation : MonoBehaviour
    {
        ...
        [SerializeField] private bool doOceanSim = false;
        ...
        [SerializeField] private ComputeShader _initialSpectrumShader;
        [SerializeField] private ComputeShader _timeDependentSpectrumShader;
        [SerializeField] private ComputeShader _foamSimulationShader;
        ...
        private int _size;
        [SerializeField] private RenderTexture _initialSpectrum;
        [SerializeField] private RenderTexture _wavesData;
        [SerializeField] private RenderTexture _initializationBuffer;
        [SerializeField] private RenderTexture _fftInOut;
        [SerializeField] private RenderTexture _turbulence;
        ...
        private void Update()
        {
            if (!doOceanSim) return;
            if (Setup())
            {
                CommandBuffer cmd = CommandBufferPool.Get("Ocean Simulation FFT");
        ...
        public RenderTexture GetFFTInOut()
        {
            return _fftInOut;
        }
        ...
        {
            return _simulationSettings.Resolution;
        }
